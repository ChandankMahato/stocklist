...
function App() {
  ...
  const PrivateRoute = ({ children }) => {
    ...
    useEffect(() => {
      if (!loading && (!user || user.email !== ("cmahato2000@gmail.com" || "tulsisingh65@gmail.com"))) {
    ...
    return user && user.email === ("cmahato2000@gmail.com" || "tulsisingh65@gmail.com") ? children : null;
  };
